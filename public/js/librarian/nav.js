...
// if (window.location.href === 'http://localhost/pothpiyasa/public/'+uid2) {
//   toggelBar.style.top = "337px";
//   toggelBar.style.visibility = 'visible';
// }
...
if (window.location.href === 'http://localhost/Pothpiyasa/public/books/deletePreview/'+uid) {
  
  toggelBar.style.top = "337px";
  toggelBar.style.visibility = 'visible';
}

if (window.location.href === 'http://localhost/pothpiyasa/public/books/delete/'+uid) {
...
if (window.location.href === 'http://localhost/pothpiyasa/public/BulkAdd/reservation_booklist_add') {
...
if (window.location.href === 'http://localhost/Pothpiyasa/public/users/deletePreview/'+uid) {
  toggelBar.style.top = "387px";
  toggelBar.style.visibility = 'visible';
}
...
let administration_nav = document.getElementById('administration_nav');
let categorylist = document.getElementById('categorylist');

administration_nav.addEventListener("mouseover", () => {
  toggelBar.style.top = "487px";
  toggelBar.style.visibility = 'visible';
  categorylist.style.visibility ='visible';
});

administration_nav.addEventListener("mouseout", () => {
  // toggelBar.style.visibility = 'hidden';
...
if (window.location.href === 'http://localhost/pothpiyasa/public/bookcategories/add/'+uid) {
  toggelBar.style.top = "487px";
  toggelBar.style.visibility = 'visible';
}
...
if (window.location.href === 'http://localhost/pothpiyasa/public/lendingcategories/add/'+uid) {
  toggelBar.style.top = "487px";
  toggelBar.style.visibility = 'visible';
}
...
if (window.location.href === 'http://localhost/pothpiyasa/public/attributes/lectureradd/'+uid) {
  toggelBar.style.top = "487px";
  toggelBar.style.visibility = 'visible';
}
...
if (window.location.href === 'http://localhost/pothpiyasa/public/attributes/studentadd/'+uid) {
  toggelBar.style.top = "487px";
  toggelBar.style.visibility = 'visible';
}
if (window.location.href === 'http://localhost/pothpiyasa/public/bookcategories/edit/'+uid) {
  toggelBar.style.top = "487px";
  toggelBar.style.visibility = 'visible';
}
if (window.location.href === 'http://localhost/pothpiyasa/public/lendingcategories/edit/'+uid) {
  toggelBar.style.top = "487px";
  toggelBar.style.visibility = 'visible';
}
if (window.location.href === 'http://localhost/pothpiyasa/public/attributes/lectureredit/Type/'+uid) {
  toggelBar.style.top = "487px";
  toggelBar.style.visibility = 'visible';
}
if (window.location.href === 'http://localhost/pothpiyasa/public/attributes/studentedit/Degree/'+uid) {
  toggelBar.style.top = "487px";
  toggelBar.style.visibility = 'visible';
}
if (window.location.href === 'http://localhost/pothpiyasa/public/attributes/studentedit/Batch/'+uid) {
  toggelBar.style.top = "487px";
  toggelBar.style.visibility = 'visible';
}
...
if (window.location.href === 'http://localhost/pothpiyasa/public/books/inventory/'+uid) {
  toggelBar.style.top = "537px";
  toggelBar.style.visibility = 'visible';
}
