...
<head>
    ...
    <link rel="stylesheet" href="<?=ROOT?>/css/librarian/editProfile.css">
...
<body>
    ...
    <?php if ($flag[0] == 1) {
        echo '<script type="text/javascript">openEditPopup("http://localhost/Pothpiyasa/public/librariandashboard")</script>';
    }
