            ...
            <?php if ($row) : ?>
                ...
                <form id="myForm" method="post" enctype="multipart/form-data">
                    ...
                    <div class="bodyContainer03">
                        ...
                        <!-- <button class="addcategorybtn" id="addcategorybtn" name="submit1">Edit</button> -->
                        <button type="button" name="bcedit" class="editbookcategorybutton" onclick="openEditCategoryPopupView()">Edit</button>
                        <button type="button" class="backbtncatecagory"><a href="<?= ROOT ?>/bookcategories/add">Back</a></button>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><button type='button' class='editbtn' id='editbtn'><i class='fa-solid fa-pen'></i>&nbsp;<a class="a1" href='<?= ROOT ?>/bookcategories/edit/<?= $row->CategoryID ?>'>
                                                Edit</a></button>
                                        <button type='button' class='deletebtn' id='deletebtn' onclick="openDeleteCategoryPopupView('<?= $row->CategoryID ?>')"><i class='fa-solid fa-trash'></i>&nbsp;
                                            Delete</button>
                                    </td>
