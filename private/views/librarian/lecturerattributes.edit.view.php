                ...
                <?php if ($row) : ?>
                    <div class="bodyContainer03">
                        ...
                        <select id="Description" class="Description1" name="Description" id="Description" value="" required>
                            ...
                            <option <?= get_select('Description', 'Type', $row[0]->Type) ?> value="type">Lec-Type</option>
                            <option <?= get_select('Description', 'Sub', $row[0]->Type) ?> value="subject">Lec-Subject</option>
                            <option <?= get_select('Description', 'Department', $row[0]->Type) ?> value="department">Lec-Department</option>
