...
<body>
    ...
    <form  method="post" enctype="multipart/form-data">
        ...
        <input type="text" name="AuthorName" class="author" id="author" value="<?= get_var('AuthorName',$row[0]->AuthorName) ?>" disabled>
        ...
        <label for="class" class="classLabelDelete">Class</label> 
        <input type="text" id="class" name="class" class="class" value="<?= get_var("Class",$row[0]->Class)?>" disabled>

        <label for="location" class="locationLabel">Location</label> 
        <input type="text" id="location" name="location" class="location" value="<?= get_var("Location",$row[0]->Location)?>" disabled>

        <label for="lendingCategory" class="lendingCategoryLabel">Lending Category</label> 
        <select id="lendingCategory" class="lendingCategory" name="LendingCategory" required disabled>
            <option value="">--- Choose Type ---</option>
