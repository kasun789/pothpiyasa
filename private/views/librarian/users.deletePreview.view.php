...
<div class="header">
        <p class="operation">Delete Preview Patron</p>
    ...
    <div class="bodyContainer01">
        ...
        <div class="bodyContainer02">
            ...
            <form method="POST">
                ...
                <button class="deletememberbtn" name="deleteMember" type="submit" style="text-decoration: none; color: white;"><a href="<?=ROOT?>/users/<?= $rowUser[0]->UserID?>">Delete</a></button>
