...
<head>
        ...
        <link rel="stylesheet" href="<?= ROOT ?>/css/librarian/history.css">
...
<body>
        <div class="header">
                ...
                <div class="profile" id="profile">
                        <img src="<?= ROOT ?>/uploads/<?= Auth::profile() ?>" alt="" srcset="" class="profileImg"
                                id="profileImg">
                </div>
                ...
                <div class="container_patron" id="container_patron">
                        ...
                        <ul>
                                <li><a href="<?= ROOT ?>/users/editProfile/<?= Auth::profileID() ?>"
                                                id="editprofile">Profile</a></li>
