...
<div class="bulkadd_container">
    <h1>Bulk Non-Academic Add To Pothpiyasa Library</h1>
    ...
    <div class="bulkadd_instruction_container">
        ...
        <ol>
            ...
            <li>The file should contains following field with giving order --> Student's[RegistrationNo, NIC, Title,
                FirstName, LastName,PhoneNo, Sex, Bithday, Address, Email].
        ...
        <div id="example_popup" class="example_popup">
            <img class="example_popup_img_nonacademic"
                src="<?= ROOT ?>/img/admin/others/bulkadd_example_nonacademic.png" alt="" srcset="">
