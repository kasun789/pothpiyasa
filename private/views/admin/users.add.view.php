...
<p class="operation">Add Patron</p>
</div>
...
<div class="bodyContainer01">
    ...
    <div class="bodyContainer02" id="bodyContainer02user">
            ...
            <div class="form-box" id="form-box">
                ...
                <div id="lectureForm" class="toggleForm">
                    ...
                    <option value="">--- Choose Type ---</option>
                        <?php
                        $lecturerType = new LecturerType();
                        $data = $lecturerType->findAll();
                        for ($i = 0; $i < count($data); $i++) {
                            echo "<option " . get_select('LecturerType', $data[$i]->ID) . " value='" . $data[$i]->ID . "'" . ">" . $data[$i]->Name . "</option>";
                        }
                    ...
                    <select id="subject" class="subject" name="Subject" disabled>
                        ...
                        $data = $lecSubject->findAll();
                        for ($i = 0; $i < count($data); $i++) {
                            echo "<option " . get_select('LecSubject', $data[$i]->ID) . " value='" . $data[$i]->ID . "'" . ">" . $data[$i]->Name . "</option>";
                        }
                    ...
                    <select id="Department" class="department" name="Department" disabled>
                    <option value="">--- Choose Type ---</option>
                        <?php
                        $lecturerDepartment = new LecturerDepartment();
                        $data = $lecturerDepartment->findAll();
                        for ($i = 0; $i < count($data); $i++) {
                            echo "<option " . get_select('LecturerDepartment', $data[$i]->ID) . " value='" . $data[$i]->ID . "'" . ">" . $data[$i]->Name . "</option>";
                        }
                ...
                <div id="studentForm" class="toggleForm">
                    ...
                    <option value="">--- Choose Type ---</option>
                        ...
                        $data = $studentDegree->findAll();
                        for ($i = 0; $i < count($data); $i++) {
                            echo "<option " . get_select('StudentDegree', $data[$i]->ID) . " value='" . $data[$i]->ID . "'" . ">" . $data[$i]->Name . "</option>";
                        }
                    ...
                    <option value="">--- Choose Type ---</option>
                        ...
                        $data = $studentBatch->findAll();
                        for ($i = 0; $i < count($data); $i++) {
                            echo "<option " . get_select('StudentBatch', $data[$i]->ID) . " value='" . $data[$i]->ID . "'" . ">" . $data[$i]->Name . "</option>";
                        }
...
<?php include('../private/views/includes/popup.add.user.view.php'); ?>
...
<!-- set the popup msg -->
<?php if ($flag[0] == 1) {
    echo '<script type="text/javascript">addUserPopup("http://localhost/pothpiyasa/public/users");</script>';
} ?>