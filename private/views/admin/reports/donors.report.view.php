<?php include('../private/views/includes/header.view.php'); ?>
        ...
        <p class="operation">Donors Report</p>
    </div>
    ...
    <form method="POST">
        ...
        <select class="issue_user_filter_typo" id="user_filter_typo" class="user_filter_typo"
            ...
            <option value="ISBN">--- Filter By Email ---</option>
        </select>
        ...
        <a href="<?= ROOT ?>/Make_pdf/donor_report/<?= $url ?>">
    ...
    <div class="donor_container_view">
        ...
        <div class="pagination_container">
            ...
            <ul>
                <li class="pag_link"><a href="<?= ROOT ?>/reports/donors?page=<?= $page_numbers['first_page_no'] ?>"><i
                            class="fa-solid fa-chevron-left"></i>&nbsp;&nbsp;First</a></li>
                <?php if ($page_numbers['previous_page_no']): ?>
                <li class="pag_link"><a
                        href="<?= ROOT ?>/reports/donors?page=<?= $page_numbers['previous_page_no'] ?>">Prev</a>
                </li>
                <?php else: ?>
                ...
                <li class="pag_link"><a
                        href="<?= ROOT ?>/reports/donors?page=<?= $page_numbers['next_page_no'] ?>">Next</a>
                </li>
                <?php else: ?>
                <li class="pag_link">Next</li>
                <?php endif; ?>
                <li class="pag_link"><a
                        href="<?= ROOT ?>/reports/donors?page=<?= $page_numbers['last_page_no'] ?>">Last&nbsp;&nbsp;<i
