...
<body style='margin:0; width: 100vw;'>
    <h1 style='text-align:center'>Lost Books Report</h1>";
    ...
    $templateString .= "
    <table style='overflow-x: auto; transform:scale(0.85); white-space:nowrap; text-align: center; border:2px solid black; margin-left:-3%; margin-top:4.5%;'>
        <tr>
            <th
