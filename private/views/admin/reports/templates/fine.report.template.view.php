...
<body style='margin:0; width: 100vw;'>
    <h1 style='text-align:center'>Fine Report</h1>";

    $templateString .= sprintf("<p style ='position:absolute; left:92px; font-size: 18px; '> Generated by : %s </p> <p style ='position:absolute; left:905px; font-size: 18px; '>Date : %s</p>",Auth::profileName(),date('Y-m-d'));

    $templateString .= "
    <table style='overflow-x: auto; transform:scale(0.85); white-space:nowrap; text-align: center; border:2px solid black; margin-left:5%; margin-top:4.5%;'>
        <tr>
            <th
