...
<body style='margin:0; width: 100vw;'>
    <h1 style='text-align:center'>Issued Books Report</h1>";
    ...
    $templateString .= "
    <table style='overflow-x: auto; transform:scale(0.85); white-space:nowrap; text-align: center; border:2px solid black; margin-left:-7%; margin-top:4.5%;'>
        <tr>
            <th
        ...
        </tr>", $row -> BookID, get_booknameReport('BookID', $row->BookID), $row->UserID, get_user_name('UserID', $row->UserID), $row->AddStaffID, get_staff_name('StaffID', $row->AddStaffID), $row->IssuedDate, $row->DueDate);
