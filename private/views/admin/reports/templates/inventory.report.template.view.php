...
<body style='margin:0; width: 100vw;'>
    ...
    $templateString .= "
    <table style='overflow-x: auto; transform:scale(0.85); white-space:nowrap; text-align: center; border:2px solid black; margin-left:-4%; margin-top:4.5%;'>
        <tr>
            <th
        ...
        </tr>", $row -> BookID, $row -> ISBN, $row -> Title, get_authorName('AuthorID', $row -> AuthorID), $row -> Edition, $row -> Language, $row -> Publisher, $row -> ReceivedDate);
