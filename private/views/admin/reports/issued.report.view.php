...
<p class="operation">Issued Books Report</p>
</div>
...
<form method="POST">
    ...
    <a href="<?= ROOT ?>/Make_pdf/issued_report/<?= $url ?>">
...
<div class="issue_container_view">
    ...
    <div class="pagination_container">
        ...
        <ul>
            <li class="pag_link"><a
                    href="<?= ROOT ?>/reports/issued_books?page=<?= $page_numbers['first_page_no'] ?>"><i
                        class="fa-solid fa-chevron-left"></i>&nbsp;&nbsp;First</a></li>
            <?php if ($page_numbers['previous_page_no']): ?>
                <li class="pag_link"><a
                        href="<?= ROOT ?>/reports/issued_books?page=<?= $page_numbers['previous_page_no'] ?>">Prev</a>
                </li>
            <?php else: ?>
            ...
            <?php if ($page_numbers['next_page_no']): ?>
                <li class="pag_link"><a
                        href="<?= ROOT ?>/reports/issued_books?page=<?= $page_numbers['next_page_no'] ?>">Next</a>
                </li>
            <?php else: ?>
                <li class="pag_link">Next</li>
            <?php endif; ?>
            <li class="pag_link"><a
                    href="<?= ROOT ?>/reports/issued_books?page=<?= $page_numbers['last_page_no'] ?>">Last&nbsp;&nbsp;<i
