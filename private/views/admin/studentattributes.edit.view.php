    ...
    <div class="options">
        ...
        <div class="drop_menu" id="drop_menu">
            ...
            <ul>
                    ...
                    <li><a href="<?= ROOT ?>/attributes/studentadd" class="active">Student</a></li>
...
<div class="bodyContainer02" onmouseover="invisible()">
                ...
                <div class="errorbookCategoryName1">
                       <?php if (isset($errors['bookCategoryName'])): ?>
                            ...
                            <label for="Descriptionlable" class="Descriptionlable1">Attribute</label>
                                ...
                                <select id="Description" class="Description1" name="Description" id="Description" value="<?= get_var('Description') ?>" required>
                                
                                        <option <?=get_select('Description','Degree',$row[0]->Type  )?> value="degree">Degree</option>
                                        <option <?=get_select('Description','Batch',$row[0]->Type  )?> value="batch">Batch</option>                           
                            ...
                            <button class="addcategorybtn181" id="addcategorybtn181" name="paadd" >Edit</button>
                            <button type="button" class="backbtncatecagory1"><a href="<?= ROOT ?>/attributes/studentadd">Back</a></button>
                ...
                <table class="category_table" id="category_table">
                        ...
                        <tr>
                                ...
                                <td ><?= $row->Name ?></td>
                                 ...
                                 <!-- //define js variable -->
                               <script type="text/javascript"> var type= '<?=  $row->Type?>'; </script>
                                <script type="text/javascript"> var id= '<?= $row->ID?>'; </script>


                                <td><button type='button' class='editbtn' id='editbtn'><i
                                                        class='fa-solid fa-pen'></i>&nbsp;<a class="a1"
                                                        href='<?= ROOT ?>/attributes/studentedit/<?= $row->Type ?>/<?= $row->ID ?>'>
                                                        Edit</a></button>
                                        <button type='button' class='deletebtn' id='deletebtn' onclick="openStudentAttributeDeleteCategoryPopupView()"><i
 ...
 <?php include('../private/views/librarian/includes/popup.StudentAttrideleteconfirmation.view.php'); ?>
