...
<head>
    ...
    <link rel="stylesheet" href="<?=ROOT?>/css/libraryStaff/bookSearch.css">
...
<body>
    ...
    <?php 
      $this->view('libraryStaff/includes/nav'); 
    ?>
...
<button class="backbtnsearchbook"><a href="<?= ROOT ?>/libraryStaffdashboard">Back</a></button>


        
</div>

    <?php $this->view('libraryStaff/includes/footer'); ?>
