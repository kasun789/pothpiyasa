  ...
  <div class="bookCopyContainer1" id="bookCopyContainer1">
    ...
    <div class="bookCopyContainer2">
      <form action="" method="post">
        ...
        <input type="number" class="noOfCopies" name="noOfCopies" min="1" required>
        ...
        <div class="container3CopyBook">
                    ...
                    <div class="donorAddBook" id="donor">
                        <label for="vendorDonor" class="vendorDonorLabel">Name</label>
                        <select id="DonorSelect" class="vendorDonor" name="DonorID" required>
                            <option value="">--- Choose Type ---</option>
                            <?php
                            $donor = new Donor();
                            $data = $donor->findAll();
                        ...
                        <input type="text" class="DonorTel" id="DonorTel" name="DonorTel"  disabled>
