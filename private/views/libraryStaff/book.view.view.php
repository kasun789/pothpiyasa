...
<head>
        ...
        <link rel="stylesheet" href="<?= ROOT ?>/css/libraryStaff/viewBook.css">
...
<body>
        ...
        <form method="POST">
                ...
                <select class="user_filter_typo" id="user_filter_typo" name="book_filter_typo">
                ...
                <input class="user_filter_typo_input" name="book_filter_typo_input" type="text">
        ...
        <!-- <div class="bodyContainerViewBook"> -->
                ...
                <div class="bodyContainer01ViewBook">
                                ...
                                <table class="user_table">
                                        ...
                                        <?php foreach ($rows as $row) : ?>
                                                <tr>
                                                        ...
                                                        <td><button type='button' class='editbtn' id='editbtn'><i class='fa-solid fa-pen'></i>&nbsp;<a href='<?= ROOT ?>/books/edit/<?= $row->BookID ?>'> Edit</a></button>

                                                                <!-- <button type='button' class='deletebtn' id='deletebtn' onclick='openDeletePopup(<?= $row->BookID ?>)'><i class='fa-solid fa-trash'></i>&nbsp;Delete</button> -->
                        ...
                        <ul>
                                <li class="pag_link"><a
                                                href="<?= ROOT ?>/books/viewbooks?page=<?= $page_numbers['first_page_no'] ?>"><i
                                ...
                                <?php if ($page_numbers['next_page_no']): ?>
                                        <li class="pag_link"><a
                                                        href="<?= ROOT ?>/books/viewbooks?page=<?= $page_numbers['next_page_no'] ?>">Next</a>
                                        </li>
                                <?php else: ?>
                                        <li class="pag_link">Next</li>
                                <?php endif; ?>
                                <li class="pag_link"><a
                                                href="<?= ROOT ?>/books/viewbooks?page=<?= $page_numbers['last_page_no'] ?>">Last&nbsp;&nbsp;<i
